...
const closeModalButtonPhoto = document.querySelector(
  "[data-hide-edit-photo-modal]"
);
const closeModalButtonVideo = document.querySelector(
  "[data-hide-edit-video-modal]"
);
const closeModalButtonAudio = document.querySelector(
  "[data-hide-edit-audio-modal]"
);
...
const submitButtonPhoto = document.querySelector(
  "[data-edit-photo-form-submit]"
);
const submitButtonVideo = document.querySelector(
  "[data-edit-video-form-submit]"
);
const submitButtonAudio = document.querySelector(
  "[data-edit-audio-form-submit]"
);
...
pickAudioButton.addEventListener("click", (e) => {
  pickAudioInput.click();
});
